                ...
                <div class="profile-picture-container mb-3">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-primary btn-sm" id="change-picture-btn">
                            <i class="fas fa-camera mr-1"></i> Ganti Image
                        </button>
                    </div>
                </div>
               <form id="profile-picture-form" action="{{ url('/profile/update-picture') }}" method="POST" enctype="multipart/form-data" style="display: none;">
                @csrf
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                            ...
                            // Update image in sidebar if ada
